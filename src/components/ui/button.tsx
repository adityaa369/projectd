  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        cta: "bg-foreground text-background hover:bg-foreground/90 shadow-elevated font-bold tracking-wide",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-card",
        checkout: "bg-foreground text-background hover:bg-foreground/90 shadow-elevated font-bold tracking-wide rounded-2xl",
        reorder: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-card rounded-xl",
      },
      size: {
