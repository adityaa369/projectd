                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredProducts.map((item) => (
                        <Card key={item.id} className="p-4 flex flex-col gap-3 hover:shadow-lg transition-shadow">
                            <div className="w-full h-48 bg-white rounded-md p-4 flex items-center justify-center">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2 mt-3">
                                    ...
                                    <span className="text-xs text-success font-medium ml-auto">{item.rating} ★</span>
                                </div>
